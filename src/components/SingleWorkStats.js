                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-12 col-lg-6">
                            <div className="row">
                                {stats.map((item, index) => <SingleWorkStatsItem key={index} statsPercent={item.improvementPercent} statsTitle={item.improvementTitle} statsDesc={item.improvementDescription} />)}
                            </div>
                        </div>
                    </div>
                </div>
